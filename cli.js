...
/*
 * ┌──────────────────────────────────────────────────────────────┐
 * │  Xync CLI — Main Entry Point                               │
 * │                                                              │
 * │  Usage:                                                      │
 * │    xync                Open interactive menu                 │
 * │    xync --setup      Run first-time setup wizard           │
 * │    xync settings     Open settings menu directly           │
 * │    xync start        Start the bot directly                │
 * │    xync status       Show system health                    │
 * │    xync report       Show reports                          │
 * └──────────────────────────────────────────────────────────────┘
 */
...
async function startBot() {
	...
	spinner.succeed(theme.accent("Launching Xync Bot..."));
...
function showHelp() {
	showBanner();
	console.log(`  ${theme.bold("Usage:")}  xync ${theme.dim("[command]")}\n`);
